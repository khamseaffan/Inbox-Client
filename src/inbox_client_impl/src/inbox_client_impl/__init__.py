...
'''
you can put all this links in constants folder and fetch from it to make it cleaner

i noticed the implementation of the other methods such as send delete and mark as read in the test and readme files but the impl is missing in the inbox_client.
